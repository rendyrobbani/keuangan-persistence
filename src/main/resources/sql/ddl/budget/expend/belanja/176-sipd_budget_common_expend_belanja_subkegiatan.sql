create or replace table data_budget_common_expend_belanja_subkegiatan (
	...
	constraint fk_data_budget_common_expend_belanja_subkegiatan_08 foreign key (created_by) references data_user (id),
	constraint fk_data_budget_common_expend_belanja_subkegiatan_09 foreign key (updated_by) references data_user (id),
	constraint fk_data_budget_common_expend_belanja_subkegiatan_10 foreign key (deleted_by) references data_user (id),
	constraint fk_data_budget_common_expend_belanja_subkegiatan_11 foreign key (locked_by) references data_user (id),
	constraint fk_data_budget_common_expend_belanja_subkegiatan_12 foreign key (rincian_locked_by) references data_user (id),
	primary key (id)
) engine = innodb
  charset = utf8mb4
