...
@MappedSuperclass
public abstract class AbstractSipdMasterRekening4Entity<
		DOMAIN extends SipdMasterRekening4<SUBJECT>,
		SUBJECT extends DataMasterRekening4
		>
		extends AbstractSipdMasterClassificationEntity<DOMAIN, SUBJECT> implements SipdMasterRekening4<SUBJECT> {
	...
	@Column(name = "subject_id", length = 9, nullable = false)
