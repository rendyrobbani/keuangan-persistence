...
@Entity
@Table(name = DataMasterKewajiban6.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "rekening5_id", "id"})})
public class DataMasterKewajiban6Entity extends AbstractDataMasterRekening6Entity<DataMasterKewajiban6> implements DataMasterKewajiban6 {
	...
	private DataMasterKewajiban5Entity rekening5;

	@Override
	public DataMasterKewajiban6 toDomain() {
		return this;
	}
