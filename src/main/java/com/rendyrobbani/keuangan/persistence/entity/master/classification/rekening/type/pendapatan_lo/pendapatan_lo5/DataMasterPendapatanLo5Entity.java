...
@Entity
@Table(name = DataMasterPendapatanLo5.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "id"})})
public class DataMasterPendapatanLo5Entity extends AbstractDataMasterRekening5Entity<DataMasterPendapatanLo5> implements DataMasterPendapatanLo5 {
	...
	@Override
	public DataMasterPendapatanLo5 toDomain() {
		return this;
	}
