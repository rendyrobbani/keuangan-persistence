...
@Entity
@Table(name = DataMasterRekeningPembiayaan6.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "rekening5_id", "id"})})
public class DataMasterRekeningPembiayaan6Entity extends AbstractDataMasterRekening6Entity<DataMasterRekeningPembiayaan6> implements DataMasterRekeningPembiayaan6 {
