...
public abstract class AbstractDataMasterClassificationRepository<ENTITY extends AbstractDataMasterClassifcationEntity<DOMAIN>, DOMAIN extends DataMasterClassificationEntity> extends AbstractRepository<ENTITY, DOMAIN, String> {
