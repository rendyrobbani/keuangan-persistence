...
insert into keuangan_dev.data_budget_common_income_pendapatan_organisasi (id, skpd_id, unit_id, total, sebelum, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
