delete from keuangan_dev.data_budget_common_income_pembiayaan_rekening;
insert into keuangan_dev.data_budget_common_income_pembiayaan_rekening (id, skpd_id, unit_id, urusan_id, bidang_id, rekening1_id, rekening2_id, rekening3_id, rekening4_id, rekening5_id, rekening6_id, sebelum, total, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
	select concat_ws('|', unit_id, bidang_id, rekening6_id) as id
		 ...
		 , null                                             as deleted_at
		 , null                                             as deleted_by
	from keuangan_dev.data_budget_common_income_pembiayaan_rincian
	where !is_deleted
