...
@Entity
@Table(name = DataMasterRekeningPembiayaan4.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "id"})})
public class DataMasterRekeningPembiayaan4Entity extends AbstractDataMasterRekening4Entity<DataMasterRekeningPembiayaan4> implements DataMasterRekeningPembiayaan4 {
	...
	@Override
	public DataMasterRekeningPembiayaan4 toDomain() {
		return this;
	}
