...
@Entity
@Table(name = DataMasterPendapatan5.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "id"})})
public class DataMasterPendapatan5Entity extends AbstractDataMasterRekening5Entity<DataMasterPendapatan5> implements DataMasterPendapatan5 {
	...
	@Override
	public DataMasterPendapatan5 toDomain() {
		return this;
	}
