...
@Entity
@Table(name = DataMasterEkuitas3.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "id"})})
public class DataMasterEkuitas3Entity extends AbstractDataMasterRekening3Entity<DataMasterEkuitas3> implements DataMasterEkuitas3 {
	...
	@Override
	public DataMasterEkuitas3 toDomain() {
		return this;
	}
