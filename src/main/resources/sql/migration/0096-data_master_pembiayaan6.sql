insert into keuangan_dev.data_master_pembiayaan6 (id, code, name, is_income, is_expend, is_enabled, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by, rekening1_id, rekening2_id, rekening3_id, rekening4_id, rekening5_id)
select *
from (
	select kode                                                   as id
		 , kode                                                   as code
