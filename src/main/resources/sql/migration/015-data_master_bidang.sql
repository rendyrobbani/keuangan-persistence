insert into keuangan_dev.data_master_bidang (id, code, name, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by, urusan_id)
select *
from (
	...
	from espresso_2025_preproduction.data_master_bidang
) t
