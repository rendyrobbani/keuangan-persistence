...
@Entity
@Table(name = DataMasterPendapatan1.TABLE_NAME)
@Checks(value = {@Check(constraints = "id like '4%'")})
public class DataMasterPendapatan1Entity extends AbstractDataMasterRekening1Entity<DataMasterPendapatan1> implements DataMasterPendapatan1 {

	@Override
	public DataMasterPendapatan1 toDomain() {
		return this;
	}
