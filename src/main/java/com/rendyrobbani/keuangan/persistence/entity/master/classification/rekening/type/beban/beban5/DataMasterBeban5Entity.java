...
@Entity
@Table(name = DataMasterBeban5.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "id"})})
public class DataMasterBeban5Entity extends AbstractDataMasterRekening5Entity<DataMasterBeban5> implements DataMasterBeban5 {
	...
	@Override
	public DataMasterBeban5 toDomain() {
		return this;
	}
