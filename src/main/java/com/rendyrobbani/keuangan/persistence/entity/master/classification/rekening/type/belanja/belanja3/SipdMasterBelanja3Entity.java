...
@Entity
@Table(name = SipdMasterBelanja3.TABLE_NAME)
public class SipdMasterBelanja3Entity extends AbstractSipdMasterRekening3Entity<SipdMasterBelanja3, DataMasterBelanja3> implements SipdMasterBelanja3 {

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumns(value = {
			@JoinColumn(name = "subject_id", referencedColumnName = "id", insertable = false, updatable = false),
	})
	private DataMasterBelanja3Entity subject;

	@Override
	public SipdMasterBelanja3 toDomain() {
		return this;
	}
