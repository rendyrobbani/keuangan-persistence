...
@Entity
@Table(name = DataMasterPembiayaan6.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "rekening5_id", "id"})})
public class DataMasterPembiayaan6Entity extends AbstractDataMasterRekening6Entity<DataMasterPembiayaan6> implements DataMasterPembiayaan6 {
	...
	@Override
	public DataMasterPembiayaan6 toDomain() {
		return this;
	}
