...
@Entity
@Table(name = DataMasterRekeningPendapatanLo3.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "id"})})
public class DataMasterRekeningPendapatanLo3Entity extends AbstractDataMasterRekening3Entity<DataMasterRekeningPendapatanLo3> implements DataMasterRekeningPendapatanLo3 {
	...
	@Override
	public DataMasterRekeningPendapatanLo3 toDomain() {
		return this;
	}
