...
@Entity
@Table(name = DataMasterRekeningPendapatan2.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "id"})})
public class DataMasterRekeningPendapatan2Entity extends AbstractDataMasterRekening2Entity<DataMasterRekeningPendapatan2> implements DataMasterRekeningPendapatan2 {
	...
	@Override
	public DataMasterRekeningPendapatan2 toDomain() {
		return this;
	}
