...
@Entity
@Table(name = DataMasterRekeningBelanja4.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "id"})})
public class DataMasterRekeningBelanja4Entity extends AbstractDataMasterRekening4Entity<DataMasterRekeningBelanja4> implements DataMasterRekeningBelanja4 {
	...
	@Override
	public DataMasterRekeningBelanja4 toDomain() {
		return this;
	}
