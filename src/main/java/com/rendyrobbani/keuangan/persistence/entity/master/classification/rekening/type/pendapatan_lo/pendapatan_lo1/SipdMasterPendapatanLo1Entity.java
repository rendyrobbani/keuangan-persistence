...
@Entity
@Table(name = SipdMasterPendapatanLo1.TABLE_NAME)
public class SipdMasterPendapatanLo1Entity extends AbstractSipdMasterRekening1Entity<SipdMasterPendapatanLo1, DataMasterPendapatanLo1> implements SipdMasterPendapatanLo1 {

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumns(value = {
			@JoinColumn(name = "subject_id", referencedColumnName = "id", insertable = false, updatable = false),
	})
	private DataMasterPendapatanLo1Entity subject;

	@Override
	public SipdMasterPendapatanLo1 toDomain() {
		return this;
	}
