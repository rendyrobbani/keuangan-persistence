...
@Entity
@Table(name = DataMasterEkuitas6.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "rekening5_id", "id"})})
public class DataMasterEkuitas6Entity extends AbstractDataMasterRekening6Entity<DataMasterEkuitas6> implements DataMasterEkuitas6 {
	...
	private DataMasterEkuitas5Entity rekening5;

	@Override
	public DataMasterEkuitas6 toDomain() {
		return this;
	}
