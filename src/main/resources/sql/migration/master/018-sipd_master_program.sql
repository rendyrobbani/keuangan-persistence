insert into keuangan_dev.sipd_master_program (id, code, name, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by, subject_id)
select *
from (
	select a.id                                                       as id
		 , a.kode                                                     as code
	...
	from espresso_2025_preproduction.sipd_master_program a
	left join espresso_2025_preproduction.data_master_program b on a.kode = b.kode
) t
