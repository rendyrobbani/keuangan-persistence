...
@Entity
@Table(name = DataMasterKewajiban2.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "id"})})
public class DataMasterKewajiban2Entity extends AbstractDataMasterRekening2Entity<DataMasterKewajiban2> implements DataMasterKewajiban2 {
	...
	@Override
	public DataMasterKewajiban2 toDomain() {
		return this;
	}
