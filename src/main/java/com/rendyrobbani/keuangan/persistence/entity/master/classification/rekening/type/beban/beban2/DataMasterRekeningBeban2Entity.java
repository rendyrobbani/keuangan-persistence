...
@Entity
@Table(name = DataMasterRekeningBeban2.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "id"})})
public class DataMasterRekeningBeban2Entity extends AbstractDataMasterRekening2Entity<DataMasterRekeningBeban2> implements DataMasterRekeningBeban2 {
	...
	@Override
	public DataMasterRekeningBeban2 toDomain() {
		return this;
	}
