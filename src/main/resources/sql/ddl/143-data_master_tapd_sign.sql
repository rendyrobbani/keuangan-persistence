create or replace table data_master_tapd_sign (
	...
	constraint ck_data_master_tapd_sign_01 check (id = concat_ws('|', lpad(number, 2, '0'), team_id)),
	constraint fk_data_master_tapd_sign_01 foreign key (team_id) references data_user (id),
	constraint fk_data_master_tapd_sign_02 foreign key (team_id) references data_master_tapd_team (id),
