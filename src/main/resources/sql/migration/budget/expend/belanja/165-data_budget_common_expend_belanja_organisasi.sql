...
insert into keuangan_dev.data_budget_common_expend_belanja_organisasi (id, skpd_id, unit_id, sebelum, total, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
