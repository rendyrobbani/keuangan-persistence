delete from keuangan_dev.data_budget_common_expend_pembiayaan_jenis;
insert into keuangan_dev.data_budget_common_expend_pembiayaan_jenis (id, skpd_id, unit_id, urusan_id, bidang_id, rekening1_id, rekening2_id, rekening3_id, sebelum, total, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
	select concat_ws('|', unit_id, bidang_id, rekening3_id) as id
		 ...
		 , null                                             as deleted_at
		 , null                                             as deleted_by
	from keuangan_dev.data_budget_common_expend_pembiayaan_rekening
	where !is_deleted
