...
@Entity
@Table(name = DataMasterRekeningAset4.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "id"})})
public class DataMasterRekeningAset4Entity extends AbstractDataMasterRekening4Entity<DataMasterRekeningAset4> implements DataMasterRekeningAset4 {
	...
	@Override
	public DataMasterRekeningAset4 toDomain() {
		return this;
	}
