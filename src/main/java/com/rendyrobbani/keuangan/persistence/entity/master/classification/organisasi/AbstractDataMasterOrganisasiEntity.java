...
public abstract class AbstractDataMasterOrganisasiEntity extends AbstractDataMasterClassifcationEntity<DataMasterOrganisasi> implements DataMasterOrganisasi {
	...
	@Override
	public void create(OrganisasiClassification classification, String name, Byte mainBidangIndex, String headId, LocalDateTime createdAt, String createdBy) {
	...
	@Override
	public void update(String name, Byte mainBidangIndex, String headId, LocalDateTime updatedAt, String updatedBy) {
		this.name = name;
		this.mainBidangIndex = mainBidangIndex;
		this.headId = headId;
