...
@Entity
@Table(name = SipdMasterPembiayaan3.TABLE_NAME)
public class SipdMasterPembiayaan3Entity extends AbstractSipdMasterRekening3Entity<SipdMasterPembiayaan3, DataMasterPembiayaan3> implements SipdMasterPembiayaan3 {

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumns(value = {
			@JoinColumn(name = "subject_id", referencedColumnName = "id", insertable = false, updatable = false),
	})
	private DataMasterPembiayaan3Entity subject;

	@Override
	public SipdMasterPembiayaan3 toDomain() {
		return this;
	}
