...
@Entity
@Table(name = DataMasterKewajiban3.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "id"})})
public class DataMasterKewajiban3Entity extends AbstractDataMasterRekening3Entity<DataMasterKewajiban3> implements DataMasterKewajiban3 {
	...
	@Override
	public DataMasterKewajiban3 toDomain() {
		return this;
	}
