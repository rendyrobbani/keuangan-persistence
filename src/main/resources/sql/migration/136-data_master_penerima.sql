insert into keuangan_dev.data_master_penerima (id, name, jenis, address, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
	select id                                                     as id
		 , nama                                                   as name
	...
	from espresso_2025_preproduction.data_master_profil
) t
