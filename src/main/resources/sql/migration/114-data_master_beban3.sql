insert into keuangan_dev.data_master_beban3 (id, code, name, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by, rekening1_id, rekening2_id)
select *
from (
	select kode                                                   as id
		 , kode                                                   as code
