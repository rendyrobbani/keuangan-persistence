...
insert into keuangan_dev.data_budget_common_expend_belanja_rekening (id, skpd_id, unit_id, urusan_id, bidang_id, program_id, program_code, kegiatan_id, kegiatan_code, subkegiatan_id, subkegiatan_code, fungsi_id, subfungsi_id, rekening1_id, rekening2_id, rekening3_id, rekening4_id, rekening5_id, rekening6_id, total, sebelum, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
	select concat_ws('|', unit_id, bidang_id, subkegiatan_id, rekening6_id) as id
		 , skpd_id                                                          as skpd_id
		 , unit_id                                                          as unit_id
	...
	where !is_deleted
	group by skpd_id, unit_id, urusan_id, bidang_id, program_id, program_code, kegiatan_id, kegiatan_code, subkegiatan_id, subkegiatan_code, fungsi_id, subfungsi_id, rekening1_id, rekening2_id, rekening3_id, rekening4_id, rekening5_id, rekening6_id
) t
