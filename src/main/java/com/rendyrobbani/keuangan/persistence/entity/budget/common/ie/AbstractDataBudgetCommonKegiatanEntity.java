...
@MappedSuperclass
public abstract class AbstractDataBudgetCommonKegiatanEntity<DOMAIN extends DataBudgetCommonKegiatanEntity> extends AbstractDataBudgetCommonEntity<DOMAIN, String> implements DataBudgetCommonKegiatanEntity {

	@Id
	@Check(constraints = "id = concat_ws('|', unit_id, bidang_id, kegiatan_id)")
