...
@Entity
@Table(name = SipdMasterEkuitas2.TABLE_NAME)
public class SipdMasterEkuitas2Entity extends AbstractSipdMasterRekening2Entity<SipdMasterEkuitas2, DataMasterEkuitas2> implements SipdMasterEkuitas2 {

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumns(value = {
			@JoinColumn(name = "subject_id", referencedColumnName = "id", insertable = false, updatable = false),
	})
	private DataMasterEkuitas2Entity subject;

	@Override
	public SipdMasterEkuitas2 toDomain() {
		return this;
	}
