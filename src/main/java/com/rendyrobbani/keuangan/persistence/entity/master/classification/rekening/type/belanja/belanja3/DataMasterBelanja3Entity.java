...
@Entity
@Table(name = DataMasterBelanja3.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "id"})})
public class DataMasterBelanja3Entity extends AbstractDataMasterRekening3Entity<DataMasterBelanja3> implements DataMasterBelanja3 {
	...
	@Override
	public DataMasterBelanja3 toDomain() {
		return this;
	}
