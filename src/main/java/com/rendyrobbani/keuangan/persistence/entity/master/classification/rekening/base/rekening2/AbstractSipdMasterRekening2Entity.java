...
@MappedSuperclass
public abstract class AbstractSipdMasterRekening2Entity<
		DOMAIN extends SipdMasterRekening2<SUBJECT>,
		SUBJECT extends DataMasterRekening2
		>
		extends AbstractSipdMasterClassificationEntity<DOMAIN, SUBJECT> implements SipdMasterRekening2<SUBJECT> {
	...
	@Column(name = "subject_id", length = 3, nullable = false)
