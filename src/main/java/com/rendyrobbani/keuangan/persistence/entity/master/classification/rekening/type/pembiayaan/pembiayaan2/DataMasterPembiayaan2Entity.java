...
@Entity
@Table(name = DataMasterPembiayaan2.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "id"})})
public class DataMasterPembiayaan2Entity extends AbstractDataMasterRekening2Entity<DataMasterPembiayaan2> implements DataMasterPembiayaan2 {
	...
	@Override
	public DataMasterPembiayaan2 toDomain() {
		return this;
	}
