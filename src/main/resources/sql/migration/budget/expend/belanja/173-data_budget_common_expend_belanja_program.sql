delete from keuangan_dev.data_budget_common_expend_belanja_program;
insert into keuangan_dev.data_budget_common_expend_belanja_program (id, skpd_id, unit_id, urusan_id, bidang_id, program_id, program_code, belanja_operasi, belanja_modal, belanja_tidak_terduga, belanja_transfer, total, belanja_operasi_sebelum, belanja_modal_sebelum, belanja_tidak_terduga_sebelum, belanja_transfer_sebelum, sebelum, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
	select concat_ws('|', unit_id, bidang_id, program_id) as id
		 , skpd_id                                        as skpd_id
		 , unit_id                                        as unit_id
		 ...
		 , null                                           as deleted_at
		 , null                                           as deleted_by
	from keuangan_dev.data_budget_common_expend_belanja_kegiatan
	where !is_deleted
	group by skpd_id, unit_id, urusan_id, bidang_id, program_id, program_code
) t
