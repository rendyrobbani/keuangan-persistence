...
@Entity
@Table(name = DataMasterRekeningPendapatanLo5.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "id"})})
public class DataMasterRekeningPendapatanLo5Entity extends AbstractDataMasterRekening5Entity<DataMasterRekeningPendapatanLo5> implements DataMasterRekeningPendapatanLo5 {
	...
	@Override
	public DataMasterRekeningPendapatanLo5 toDomain() {
		return this;
	}
