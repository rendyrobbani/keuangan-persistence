...
@Entity
@Table(name = DataMasterRekeningEkuitas4.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "id"})})
public class DataMasterRekeningEkuitas4Entity extends AbstractDataMasterRekening4Entity<DataMasterRekeningEkuitas4> implements DataMasterRekeningEkuitas4 {
	...
	@Override
	public DataMasterRekeningEkuitas4 toDomain() {
		return this;
	}
