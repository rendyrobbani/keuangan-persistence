create or replace table data_budget_common_expend_belanja_rekening (
	...
	constraint fk_data_budget_common_expend_belanja_rekening_08 foreign key (fungsi_id) references data_master_fungsi (id),
	constraint fk_data_budget_common_expend_belanja_rekening_09 foreign key (fungsi_id, subfungsi_id) references data_master_subfungsi (fungsi_id, id),
	constraint fk_data_budget_common_expend_belanja_rekening_10 foreign key (rekening1_id) references data_master_belanja1 (id),
	constraint fk_data_budget_common_expend_belanja_rekening_11 foreign key (rekening1_id, rekening2_id) references data_master_belanja2 (rekening1_id, id),
	constraint fk_data_budget_common_expend_belanja_rekening_12 foreign key (rekening1_id, rekening2_id, rekening3_id) references data_master_belanja3 (rekening1_id, rekening2_id, id),
	constraint fk_data_budget_common_expend_belanja_rekening_13 foreign key (rekening1_id, rekening2_id, rekening3_id, rekening4_id) references data_master_belanja4 (rekening1_id, rekening2_id, rekening3_id, id),
	constraint fk_data_budget_common_expend_belanja_rekening_14 foreign key (rekening1_id, rekening2_id, rekening3_id, rekening4_id, rekening5_id) references data_master_belanja5 (rekening1_id, rekening2_id, rekening3_id, rekening4_id, id),
	constraint fk_data_budget_common_expend_belanja_rekening_15 foreign key (rekening1_id, rekening2_id, rekening3_id, rekening4_id, rekening5_id, rekening6_id) references data_master_belanja6 (rekening1_id, rekening2_id, rekening3_id, rekening4_id, rekening5_id, id),
	constraint fk_data_budget_common_expend_belanja_rekening_16 foreign key (created_by) references data_user (id),
	constraint fk_data_budget_common_expend_belanja_rekening_17 foreign key (updated_by) references data_user (id),
	constraint fk_data_budget_common_expend_belanja_rekening_18 foreign key (deleted_by) references data_user (id),
	primary key (id)
) engine = innodb
  charset = utf8mb4
