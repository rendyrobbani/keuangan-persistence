insert into keuangan_dev.data_master_priority_of_provinsi (id, year, number, name, sipd_name, is_locked, locked_at, locked_by, created_at, created_by, updated_at, updated_by, is_deleted, deleted_at, deleted_by)
select *
from (
	select id                                                     as id
		 , tahun                                                  as year
	...
	from espresso_2025_preproduction.data_master_label_provinsi
) t
