...
@Entity
@Table(name = DataMasterPendapatan6.TABLE_NAME, uniqueConstraints = {@UniqueConstraint(columnNames = {"rekening1_id", "rekening2_id", "rekening3_id", "rekening4_id", "rekening5_id", "id"})})
public class DataMasterPendapatan6Entity extends AbstractDataMasterRekening6Entity<DataMasterPendapatan6> implements DataMasterPendapatan6 {
	...
	private DataMasterPendapatan4Entity rekening4;
	...
	private DataMasterPendapatan5Entity rekening5;

	@Column(name = "is_enabled", nullable = false)
	private boolean isEnabled;

	@Override
	public DataMasterPendapatan6 toDomain() {
		return this;
	}
